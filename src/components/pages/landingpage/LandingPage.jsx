    ...
    <div className="landing-page" >
     ...
     <div className='section-2'>
        ...
        <div className='section-2-text-cont'>
            <h3 className='section-2-h3'>Find your perfect angle</h3>
      ...
      <div className='section-3'>
        ...
        <div className='section-3-text-cont'>
            <h3 className='section-3-h3'>Find your perfect angle</h3>
      ...
      <div className='section-4'>
        ...
        <div className='section-4-text-cont'>
            <h3 className='section-4-h3'>Find your perfect angle</h3>
      ...
      <div className='section-5'>
        <div className='section-5-img-cont'>
            <img src={land1} alt='land-image' className='land-image'/>
        </div>
        <div className='section-5-text-cont'>
            <h3 className='section-5-h3'>Find your perfect angle</h3>
